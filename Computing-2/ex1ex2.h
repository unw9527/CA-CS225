...
class patient {///
	public:
		...
		int treatment;  // Different kinds of treatment (1,2 or 3) 
		
		/* Class Functions */
		patient();
		patient(int nid, char nam[30], int pro, int tim, int ris, int phone, int bir, char state[10],int treatment);
		  //~patient();
		void age_rank();
...
patient::patient(int nid, char nam[30], int pro, int tim, int ris, int phone, int bir, char state[10], int tre_men) {
	this->id=nid;
